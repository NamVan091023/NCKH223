...
class _NewsScreenState extends State<NewsScreen> {
  ...
  Future<void> getNews({
    ...
    baseApi = 'https://newsapi.org/v2/everything?q=giao%20thông&apiKey=$apiKey&pageSize=10&page=$pageNum&';
    print("check $baseApi");
    ...
    if (channel != null) {
      country = null;
      category = null;
      // baseApi = 'https://newsapi.org/v2/everything?q=giao%20thông&pageSize=10&page=$pageNum&sources=$channel&apiKey=58b98b48d2c74d9c94dd5dc296ccf7b6';
    }
    if (searchKey != null) {
      country = null;
      category = null;
      // baseApi ='https://newsapi.org/v2/everything?q=giao%20thông&pageSize=10&page=$pageNum&q=$searchKey&apiKey=58b98b48d2c74d9c94dd5dc296ccf7b6';
    }
    //print(baseApi);
